...
# rngf_FL => rangefinder   front  left 
# rngf_FM => rangefinder   front  middle 
# rngf_FR => rangefinder   front  right 
# rngf_ML => rangefinder  middle  left 
# rngf_MR => rangefinder  middle  right 
# rngf_RM => rangefinder    rear  middle 
